 ...
 *
 */
public final class SortedComboBox extends JComboBox {
	 ...
	 * @author Nina Rothenberg
	 */
	final class SortedComboBoxModel extends DefaultComboBoxModel {
		...
		public void addElement(Object anObject) {
	        throw new UnsupportedOperationException("Kein Element darf hinzugef&uuml;gt werden, denn es wird nicht sortiert.");
	    }

	    @Override
	    public void insertElementAt(Object anObject, int index) {
	        throw new UnsupportedOperationException("Kein Element darf an eine bestimmte Stelle hinzugef&uuml;gt werden, denn es wird nicht sortiert.");
	    }
